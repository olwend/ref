$(document).ready(function() {
  ...
  jQuery('.dinosaur--comparison-human').html('<img alt="human silhouette for scale comparison" src="/etc/designs/nhmwww/img/svgs/dinodirectory/human/'+humanOutline+humanSuffix+'.svg"/>').css('width', humanWidth+'%');
