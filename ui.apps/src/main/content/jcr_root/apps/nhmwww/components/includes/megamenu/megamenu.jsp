                        ...
                        <li class="nav-list__item has-children shop">
                            ...
                            <div class="nav-list level-2">
                                <ul class="dropdown-section">
                                    ...
                                    <li class="nav-list__item">
                                        <a href="http://www.nhmshop.co.uk/jewellery/view-all-jewellery.html?utm_source=nhm.ac.uk&utm_medium=referral&utm_campaign=&utm_content=meganav-link1">Jewellery</a>
                                    </li>
                                    <li class="nav-list__item">
