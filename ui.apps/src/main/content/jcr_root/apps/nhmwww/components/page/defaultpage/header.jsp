  ...
  <div class="global-header-bar global-info-menu">
      <div class="row cf">
          ...
          <a href="#" id="mobile-navigation" class="mobile global-menu-trigger">
              ...
              <i class="ico svg-ico ico-menu-close" data-svg-src="/etc/designs/nhmwww/img/svg-icons/icon_l_general_close.svg" data-svg-title="icon__menu_close" data-alt="Close Menu" data-stroke-width="15" data-base-color="#A8A8A8" data-fallback="/etc/designs/nhmwww/img/mobile-menu.png"></i>
