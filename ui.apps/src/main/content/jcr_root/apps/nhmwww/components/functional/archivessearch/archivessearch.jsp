  ...
  <div class="primo-search">
    ...
    <div id="primo-search-bar">
      <form id="PrimoSearchForm" name="PrimoSearchForm" method="post"
        ...
        <input name="vl(freeText0)" class="primo-search-style" id="primo-searchq"
          accesskey="s" placeholder="Enter search terms &ellipsis;" size="60"
          type="text"> <input name="mode" value="Basic" type="hidden">
        <input name="tab" value="default_tab" type="hidden"> <input
          name="vid" value="44NHM_V1" type="hidden"> <input
          value="Search" name="primo-searchopt" id="primo-searchopt" type="button"
          onclick="javascript:document.getElementById('PrimoSearchForm').submit();">
      </form>
      <div class="advanced">
        <a
          href="http://primo-44nhm.hosted.exlibrisgroup.com/primo_library/libweb/action/search.do?mode=Advanced&ct=AdvancedSearch&fn=search&vid=44NHM_V1">Advanced
          search</a>
      </div>
    </div>
  </div>
