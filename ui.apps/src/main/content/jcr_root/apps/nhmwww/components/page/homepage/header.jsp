...
<header class="global-header cf">
	<div class="global-header-bar global-info-menu">
                <div class="row cf">
                    <a href="/" class="global-header-logo home"><span class="ir">Natural History Museum</span></a>
