			...
			<li>
				...
				<div class="small-12 medium-12 large-12 columns">
					<select id="division">
						...
						<option class="division" id="Diversity and Informatics" value="Diversity and Informatics" data-department="Life Sciences" data-division="Division of Diversity and Informatics">&nbsp;&nbsp;&nbsp;&nbsp;Diversity and Informatics</option>
