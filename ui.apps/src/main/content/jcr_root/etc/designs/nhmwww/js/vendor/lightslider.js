        ...
        plugin = {
            ...
            controls: function() {
                if (settings.controls) {
                    if(!$el.closest('.lSSlideOuter').hasClass('noPager')){
                        $el.after('<div class="lSAction"><a class="lSPrev">' + settings.prevHtml + '</a><a class="lSNext">' + settings.nextHtml + '</a></div>');
                        // if($el.hasClass('carousel')) 
                        //     $el.closest('.lSSlideOuter').find('.lSGallery').after('<div class="lSAction thumbnail-scroll"><a class="lSPrev">' + settings.prevHtml + '</a><a class="lSNext">' + settings.nextHtml + '</a></div>');
                        var $prev = $slide.closest('.lSSlideOuter').find('.lSPrev');
                        var $next = $slide.closest('.lSSlideOuter').find('.lSNext');
            ...
            initialStyle: function() {
                ...
                $el.addClass('lightSlider').wrap("<div class='lSSlideOuter'><div class='lSSlideWrapper'></div></div>");
                ...
                refresh.createPager = function() {
                    ...
                    for (i = 0; i < maxSlide; i++) {
                        ...
                        var thumb = $children.eq(i * settings.slideMove).attr('data-thumb'),
                            video = '';
                        if($children.eq(i * settings.slideMove).attr('data-type')==='video') video = 'class="video" ';
                        if (settings.gallery === true) {
                            ...
                            pagers += '<li ' + video + 'style="width:100%;' + property + ':' + thumbWidth + 'px;' + gutter + ':' + settings.thumbMargin + 'px"><a href="javascript:void(0)"><img src="' + thumb + '" /></a></li>';
                        } else {
