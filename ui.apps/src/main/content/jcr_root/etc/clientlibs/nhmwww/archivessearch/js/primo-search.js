...
$('.search-container').css({'background-image': 'url(/resources/research-curation/library-search/css/images/' + images[Math.floor(Math.random() * images.length)] + ')'});

  //get which current tab in form (i.e. form entered via back button
