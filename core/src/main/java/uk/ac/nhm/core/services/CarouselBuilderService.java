...
import uk.ac.nhm.core.componentHelpers.CarouselHelper;
import uk.ac.nhm.core.model.CarouselElement;
...
@Properties(value = {
	@Property(name = "service.pid", value = "uk.ac.nhm.core.delivery.service.CarouselBuilderService", propertyPrivate = false)
})
