package uk.ac.nhm.core.impl.workflows.science;
...
import uk.ac.nhm.core.impl.workflows.science.generated.AcademicAppointment;
import uk.ac.nhm.core.impl.workflows.science.generated.AcademicAppointments;
import uk.ac.nhm.core.impl.workflows.science.generated.Address;
import uk.ac.nhm.core.impl.workflows.science.generated.Degree;
import uk.ac.nhm.core.impl.workflows.science.generated.Degrees;
import uk.ac.nhm.core.impl.workflows.science.generated.EmailAddress;
import uk.ac.nhm.core.impl.workflows.science.generated.Field;
import uk.ac.nhm.core.impl.workflows.science.generated.Line;
import uk.ac.nhm.core.impl.workflows.science.generated.Link;
import uk.ac.nhm.core.impl.workflows.science.generated.NonAcademicEmployment;
import uk.ac.nhm.core.impl.workflows.science.generated.NonAcademicEmployments;
import uk.ac.nhm.core.impl.workflows.science.generated.Ns1Object;
import uk.ac.nhm.core.impl.workflows.science.generated.OrganisationDefinedData;
import uk.ac.nhm.core.impl.workflows.science.generated.Person;
import uk.ac.nhm.core.impl.workflows.science.generated.PhoneNumber;
import uk.ac.nhm.core.impl.workflows.science.generated.Record;
import uk.ac.nhm.core.impl.workflows.science.generated.WebAddress;
import uk.ac.nhm.core.impl.workflows.science.generated.WebProfile;
import uk.ac.nhm.core.impl.workflows.science.generated.WebProfile.Grants;
import uk.ac.nhm.core.impl.workflows.science.generated.WebProfile.ProfessionalActivities;
import uk.ac.nhm.core.impl.workflows.science.generated.WebProfile.Projects;
import uk.ac.nhm.core.impl.workflows.science.generated.WebProfile.Projects.ChampionOf.Project;
import uk.ac.nhm.core.impl.workflows.science.generated.WebProfile.TeachingActivities;
import uk.ac.nhm.core.impl.workflows.science.generated.WebProfile.TeachingActivities.Associated.Activity;
import uk.ac.nhm.core.services.ScientistsGroupsService;
import uk.ac.nhm.core.xmlvalidation.XMLDateFieldValidator;
import uk.ac.nhm.core.xmlvalidation.XMLPaginationFieldValidator;
...
//        this.imagesPath = "C:\\science-profiles\\NHM-images\\";
	...
	private void addPublication (final Node rootNode, final List<WebProfile.Publications.Contributed.Publication> publications) throws Exception {
		...
		for (WebProfile.Publications.Contributed.Publication publication : publications) {
			...
			for (Record record: publication.getObject().getRecords().getRecord()) {
				...
				//Only take the publication data for the user's preferred record
				if(Boolean.TRUE.equals(record.isIsPreferredRecord())) {

					publicationsNode.setProperty(ScientistProfileHelper.PREFERRED_ATTRIBUTE, record.isIsPreferredRecord());
					...
					for (Field field: record.getNative().getField()) {
						...
						case "issue":
							...
							break;
						case "pagination":
							final String startPage = field.getPagination().getBeginPage();
							if (startPage != null) {
								publicationsNode.setProperty(ScientistProfileHelper.START_PAGE_ATTRIBUTE, startPage);
							}

							final String endPage = field.getPagination().getEndPage();
							if (endPage != null) {
								publicationsNode.setProperty(ScientistProfileHelper.END_PAGE_ATTRIBUTE, endPage);
							}

							final BigInteger pageCount = field.getPagination().getPageCount();
							if (pageCount != null) {
	...
	private int projectNodeTypeAssign(int i, final Node rootNode, ListIterator<Project> projects, String nodeType) throws Exception {
		...
		while (projects.hasNext()){
			uk.ac.nhm.core.impl.workflows.science.generated.WebProfile.Projects.ChampionOf.Project project = projects.next();
