...
import uk.ac.nhm.core.model.youtube.Video;
import uk.ac.nhm.core.model.youtube.YouTubeVideosPage;
...
@Properties(value = {
        ...
        @Property(name = "service.pid", value = "uk.ac.nhm.core.impl.services.YouTubeCollectorService", propertyPrivate = false),
