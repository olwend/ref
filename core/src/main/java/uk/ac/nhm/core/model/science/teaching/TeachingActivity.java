...
public class TeachingActivity extends TeachingActivityTemplate {

	private Organisation[] organisations;

	public TeachingActivity(String url, String title, final String reportingDate, String yearStartDate, String monthStartDate, String dayStartDate, 
