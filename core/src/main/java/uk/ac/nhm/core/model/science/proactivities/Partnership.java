...
public class Partnership extends ProfessionalActivity {

	private Organisation[] organisations;

	public Partnership(String url, String title, final String reportingDate, String yearStartDate, String monthStartDate, String dayStartDate, 
