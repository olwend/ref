...
public class ThesisDisertation extends Publication{
	
	public ThesisDisertation(final String title, final  List<String> authorsList, final  boolean favorite, final  int publicationYear,
