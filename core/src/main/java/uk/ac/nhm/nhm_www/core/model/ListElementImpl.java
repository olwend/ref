...
public class ListElementImpl implements ListElement {
	...
	/* (non-Javadoc)
	 * @see uk.ac.nhm.nhm_www.core.model.ListElement#getTitle()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see uk.ac.nhm.nhm_www.core.model.ListElement#setTitle(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see uk.ac.nhm.nhm_www.core.model.ListElement#getElementLink()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see uk.ac.nhm.nhm_www.core.model.ListElement#setElementLink(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see uk.ac.nhm.nhm_www.core.model.ListElement#isInitialised()
	 */
	@Override
