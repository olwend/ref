...
public class TaggedFeedListElementArrayImpl implements TaggedFeedListElementArray {
    ...
    /* (non-Javadoc)
	 * @see uk.ac.nhm.nhm_www.core.model.TaggedFeedListElementArray#getComplexObjectArray()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see uk.ac.nhm.nhm_www.core.model.TaggedFeedListElementArray#getCreatedAt()
	 */
    @Override
	...
	/* (non-Javadoc)
	 * @see uk.ac.nhm.nhm_www.core.model.TaggedFeedListElementArray#getIndexMap()
	 */
	@Override
    ...
    /* (non-Javadoc)
	 * @see uk.ac.nhm.nhm_www.core.model.TaggedFeedListElementArray#addResource(uk.ac.nhm.nhm_www.core.model.TaggedFeedListElementImpl)
	 */
    @Override
