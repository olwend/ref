...
public class PressReleaseFeedListElementImpl extends FeedListElementImpl implements PressReleaseFeedListElement {
	...
	/* (non-Javadoc)
	 * @see uk.ac.nhm.nhm_www.core.model.PressReleaseFeedListElement#isInitialised()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see uk.ac.nhm.nhm_www.core.model.PressReleaseFeedListElement#setPressReleaseDate(java.util.Date)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see uk.ac.nhm.nhm_www.core.model.PressReleaseFeedListElement#getPressReleaseDate()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see uk.ac.nhm.nhm_www.core.model.PressReleaseFeedListElement#compareTo(uk.ac.nhm.nhm_www.core.model.PressReleaseFeedListElementImpl)
	 */
