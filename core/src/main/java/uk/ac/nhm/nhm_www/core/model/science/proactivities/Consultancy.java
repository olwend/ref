...
public class Consultancy extends ProfessionalActivity {

	private Organisation[] organisations;

	public Consultancy(String url, String title, final String reportingDate, String yearStartDate, String monthStartDate, String dayStartDate, 
